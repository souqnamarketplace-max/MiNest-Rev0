...
const ChartStyle = ({
  ...
  // SECURITY: Sanitize all values before injecting into CSS
  // Only allow valid CSS color values (hex, rgb, hsl, named colors, CSS vars)
  const sanitizeCSSValue = (value) => {
    if (typeof value !== 'string') return null;
    // Allow: hex colors, rgb/rgba, hsl/hsla, CSS custom properties, named colors
